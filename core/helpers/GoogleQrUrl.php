...
final class GoogleQrUrl
{
    ...
    public static function generate(string $accountName, string $secret, ?string $issuer = null, int $size = 200): string
    {
        ...
        return "https://chart.googleapis.com/chart?cht=qr&chs=300x300&chl=$otpauthString";
       // return sprintf(
            
           // 'https://api.qrserver.com/v1/create-qr-code/?size=%1$dx%1$d&data=%2$s&ecc=M',$size,$otpauthString
       // );
    }
}

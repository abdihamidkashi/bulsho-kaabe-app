											...
											<div class="row">
												<div class="col-lg-12 col-md-12 col-xl-6">
													<div class="wideget-user-desc d-sm-flex">
														<div class="wideget-user-img">
															<img class="" src="<?php echo URLROOT.'/'.$_SESSION['image'];?>" width="128px" height="128px" alt="img">
														</div>
														<div class="user-wrap">
															<h4><?php echo $_SESSION['full_name'];?></h4>
															<h6 class="text-muted mb-3 d-none">Member Since: <?php echo $data['profile']->since_member;?></h6>
												...
												<div class="col-lg-12 col-md-12 col-xl-6">
													<div class="text-xl-right mt-4 mt-xl-0">
														...
														<a href="<?php echo URLROOT;?>/forms/create/<?php echo $_SESSION['user_teacher'] == 'teacher' ? 'change-password.' : 'change-password';?>"  class="btn btn-primary">Change Password</a>
													</div>
													<div class="mt-5">
															...
															<div class="me-0 mt-5 mt-md-0">
																<div class="media">
																	<div class="media-icon bg-orange me-3 mt-1">
																		<i class="fa fa-money fs-20 text-white"></i>
																	</div>
																	<div class="media-body">
											...
											<div class="card-body">
											    ...
											    <div class="table-responsive ">
													<table class="table row table-borderless">
														<?php foreach($data['profile'] as $k => $v){?>
														<tbody class="col-lg-12 col-xl-6 p-0">
															<tr>
																<td><strong><?php echo $k;?> :</strong> <?php echo $v;?></td>
															</tr>
												...
												<div class="row profie-img d-none">
													<div class="col-md-12">
														<div class="media-heading">

<style>
  ...
  .required {
	...
	<div class="limiter">
	    <div class="payment-msg d-none">Fadlan fiiri taleefanka aad lacagta ka bixineyso oo soo geli Pin-ka EVC-ga</div>
	   <?php $d = $data['doctor'][0];?>
	    ...
	    <hr/>
           <div class="doctor-box" id="<?php echo $d->auto_id;?>"  style="border-bottom: 1px solid #666;margin-bottom:3px;">
            ...
            <p><small>Kusoo dhawoow App-ka Dalbashada Ticket-ka Isbitaalada ee <b>BULSHO TECH</b>, Qiimaha Ticket-ka Isbitaalka <?php echo $d->hospital;?> waa <?php echo $d->ticket_fee;?>, Lacagta khidmadda ee Bulsho Tech waa <?php echo $d->service_fee;?>, Wadarta guud waa <?php echo $d->total_fee;?></small></p>
  <form action="<?php echo URLROOT;?>/portal/checkout" method="POST" id="ticket-order">
    ...
    <input type="hidden" name="amount" value="<?php echo $d->total_fee;?>"/>

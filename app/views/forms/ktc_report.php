...
array_walk($flattened, function(&$value, $key) {
 ...
 $post = implode(', ', $flattened);
                ?>
                <div class="alert alert-danger">
                                <strong>Error accurred !</strong> there is an error for your request please 
                                <a href="<?php echo URLROOT;?>/forms/save" class="ktc-error-report"
                                data="sp=476&aut=0&di_oc=1&cat=-1&sub=-1&link=<?php echo $data['formname'];?>&descr=Error: <?php echo $data['result']['errorMessage'];?> - Post:<?php echo $post;?>&screensho=&status=0&di_resu=0&date=<?php echo date('Y-m-d');?>">Report us</a> to solve thanks. 
...
<?php  if(  @$_POST['_lang'] == 'AR' || @$_POST['lang_p'] == 'AR' || @$_POST['_language'] == 'AR' ){

$dir =  'RTL' ;
?>
<script>
$("#report-header2").addClass("rtl");
</script>
<?php
}
             ?>
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        $tab++;
                            ...
                            <?php  
                            }elseif(!empty($k[1]) && (strpos($k[1], 'force_dropdown') !== false || strpos($k[1], 'dropdown') !== false)){
    							$v = explode("|", $val);
   								 
   							 ?>
    					        <td  title="<?php echo $k[1].$val;?>" class="select <?php echo @$k[1];?>"  alt="<?php echo @$k[3];?>">
                             ...
                             title="<?php echo 'action:'.$k[2].', def val:'.$v[0]. ', un:'. $v[1];?>">
									<option value="" >Select One/Empty </option>
